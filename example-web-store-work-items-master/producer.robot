...
Split orders file
    ...
    EXCEPT    FileNotFoundError    type=START
        Copy file    C:/Users/Jan/Desktop/moje/MyRobocorp/example-web-store-work-items-master/devdata/work-items-in/split-orders-file-test-input/orders.xlsx    orders.xlsx
    END
